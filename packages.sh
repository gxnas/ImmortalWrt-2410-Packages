...
git clone --depth=1 -b openwrt-24.10 https://github.com/immortalwrt/luci.git
mv luci/applications/* .
rm -rf luci

git clone --depth=1 https://github.com/danchexiaoyang/luci-app-onliner.git
mv luci-app-onliner danchexiaoyang-onliner
mv danchexiaoyang-onliner/* .
rm -rf danchexiaoyang-onliner
